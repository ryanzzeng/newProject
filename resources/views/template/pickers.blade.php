@extends('layouts/default') {{-- Page title --}} @section('title') Pickers @stop {{-- local styles --}} @section('header_styles')
...
<link href="{{asset('vendors/clockpicker/css/bootstrap-clockpicker.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('vendors/bootstrap-switch/css/bootstrap-switch.css')}}" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="{{asset('css/pickers.css')}}"> @stop {{-- Page Header--}} @section('page-header')
...
<script src="{{asset('vendors/bootstrap-switch/js/bootstrap-switch.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/toolbar/js/jquery.toolbar.min.j')}}s"></script>
<script src="{{asset('js/custom_js/pickers.js')}}" type="text/javascript"></script> @stop
