@extends('layouts/default') {{-- Page title --}} @section('title') Fontawesome Icons @stop {{-- local styles --}} @section('header_styles')
<link href="vendors/toastr/css/toastr.min.css" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="css/custom_css/fontawesome_icons.css"> @stop {{-- Page Header--}} @section('page-header')
...
<script src="js/custom_js/fontawesome_icons.js" type="text/javascript"></script> @stop
