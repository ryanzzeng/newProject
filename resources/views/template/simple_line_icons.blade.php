@extends('layouts/default') {{-- Page title --}} @section('title') Simple Line Icons @stop {{-- local styles --}} @section('header_styles')
...
<link rel="stylesheet" type="text/css" href="{{asset('css/custom_css/simple_themify.css')}}">@stop {{-- Page Header--}} @section('page-header')
...
<script src="{{asset('js/custom_js/simple_line_icons.js')}}"></script> @stop
