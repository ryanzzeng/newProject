@extends('layouts/default') {{-- Page title --}} @section('title') Bootstrap Datatables @stop {{-- local styles --}} @section('header_styles')
<link rel="stylesheet" href="{{asset('vendors/bootstrap-table/css/bootstrap-table.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('css/custom_css/bootstrap_tables.css')}}"> @stop {{-- Page Header--}} @section('page-header')
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel filterable">
            ...
            <div class="panel-body">
                <table data-toggle="table" data-sort-name="age" data-sort-order="desc" data-pagination="true" data-search="true" data-height="400">
                    <thead>
                        <tr>
...
<!--fourth table end-->@stop {{-- local scripts --}} @section('footer_scripts')
...
<script type="text/javascript" src="{{asset('vendors/tableExport/tableExport.min.js')}}"></script>
<script src="{{asset('js/custom_js/bootstrap_tables.js')}}" type="text/javascript"></script>
@stop
