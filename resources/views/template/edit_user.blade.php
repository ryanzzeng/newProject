@extends('layouts/default') {{-- Page title --}} @section('title') Edit User @stop {{-- local styles --}} @section('header_styles')
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
                                                <img src="img/authors/avatar1.jpg" alt="profile pic" class="profile_pic">
                                            </div>
