@extends('layouts/default') {{-- Page title --}} @section('title') Complex Forms 2 @stop {{-- local styles --}} @section('header_styles')
<!-- page level css -->
...
<link rel="stylesheet" type="text/css" href="{{asset('css/custom_css/complex_forms2.css')}}" />
<!-- end of page level css -->
@stop {{-- Page Header--}} @section('page-header')
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>Complex Forms 2</h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{url('index')}}">
        ...
        <form class="grid-form form-horizontal">
            ...
            <fieldset>
                ...
                <div data-row-span="4">
                    ...
                    <p class="text-danger">If you are an existing customer please move directly to section "c"
                    </p>
                </div>
                <div data-row-span="4">
                    ...
                    <div data-field-span="1">
                        ...
                        <div data-col-span="1">
                            ...
                            <label>
                                <input type="radio" name="optionsRadios1" value="Female" class="square-blue1">&nbsp;Female
                            </label>
                            <label>
                                <input type="radio" name="optionsRadios1" value="Other" class="square-blue1">&nbsp;Other
                            </label>
                        </div>
                        <div data-col-span="1">
                            ...
                            <label>
                                <input type="radio" name="optionsRadios2" value="Female" class="square-blue2">&nbsp;Female
                            </label>
                            <label>
                                <input type="radio" name="optionsRadios2" value="Other" class="square-blue2">&nbsp;Other
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <fieldset>
                <div data-row-span="4">
                    ...
                    <div data-field-span="4">
                        ...
                        <label for="company_name" class="control-label">Company Name/Flat No. & Bldg.Name </label>
                        ...
                        <input class="form-control" id="email_id" type="text" data-field-error="Please enter a valid email address">
                    </div>
                </div>
                <div data-row-span="4">
                    <div data-field-span="2">
            ...
            <div data-row-span="2">
                <div data-field-span="1">
                    <label for="guardian">In case of a minor please provide details (Name of parent and natural guardian)
                    </label>
            ...
            <div data-row-span="3">
                <div data-col-span="3">
                    <label>If any of the applicants are EXISTING ACCOUNT HOLDERS,please mention the customer Identification No:</label>
                </div>
            </div>
            <div data-row-span="3">
                <div data-field-span="1">
            ...
            <fieldset>
                ...
                <div data-row-span="4">
                    ...
                    <div data-field-span="1">
                        ...
                        <label>
                            <input type="radio" name="optionsRadios4" class="square-blue">&nbsp;Cash</label>
                        <label>
                            <input type="radio" name="optionsRadios4" class="square-blue">&nbsp;Cheque</label>
                    </div>
                </div>
            </fieldset>
            ...
            <div data-row-span="1">
                <div data-field-span="1">
                    ...
                    <label>
                        <input type="radio" name="optionsRadios5" class="square-blue">&nbsp;Either/Any one or Survivor
                    </label>
                    <label>
                        <input type="radio" name="optionsRadios5" class="square-blue">&nbsp;Jointly ( Debit / ATM card will not be issued)*
                    </label>
                </div>
            </div>
            <p>Please Note: Cheque book of 25 leaves & 50 leaves will be issued to Savings and Current a/c holders respectively by default. </p>
            <fieldset>
            ...
            <fieldset>
                ...
                <div data-row-span="4">
                    <div data-field-span="4">
                        <label for="average_quaterly_balance">The Average Quarterly Balance (AQB) required to be maintained for this account is Rs:</label>
            ...
            <fieldset>
                <div data-row-span="2">
                    <p>DECLARATION :I/We have read and understood the Terms & Conditions governing the opening of an account with HDFC Bank and those relating to various services including but not limited to (A) ATMs, (B) PhoneBanking, (C) Debit Cards, (D) MobileBanking, (E) NetBanking, (F) BillPay facility. I/We accept and agree to be bound by the said Terms & Conditions including those excluding /limiting the Bank's liability. I/We understand that the Bank may, at its absolute discretion, discontinue any of the services completely or partially without any notice to me/us. I/We agree that the Bank may debit my/our account for the service charges applicable from time to time. I/We confirm that I/We am/are resident of India. I/We authorise the Bank to disclose, from time to time any information relating to my savings account to any parent/subsidiary, affiliate and associate of HDFC Bank, and to third parties engaged by the Bank, for purposes as detailed in the Terms & Conditions Booklet. I/We confirm that I/We am/are in possession of and have read the Terms and Conditions booklet which details the rules governing account operations, the schedule of charges which specifies the charges applicable from time to time for various services and the tear away Customer copy detailing the instructions and account opening rules. I /We have understood that I/We am/are required to maintain:
                    </p>
                </div>
                <div data-row-span="6">
                    <div data-field-span="2">
            ...
            <div data-row-span="4">
                <div data-field-span="2">
                    <p>I/We confirm that I/We have read and understood the Declaration given above and confirm that all the details provided on the form are correct.I/We also confirm that my/our account has been opened by Bank Officer Mr./Ms.
                        <textarea class="resize_vertical" placeholder="Name"></textarea>& I/We have signed in his/her presence.</p>
                </div>
                <div data-field-span="2">
                    <label>Name:
            ...
            <fieldset>
                ...
                <div data-row-span="18">
                    <div data-field-span="3">
                        ...
                        <label for="income_below50"><i class="fa ti-angle-left" aria-hidden="true"></i> 50,000
                        </label>
                    </div>
                    <div data-field-span="3">
...
<script src="{{asset('js/custom_js/complex_form2.js')}}" type="text/javascript"></script>
