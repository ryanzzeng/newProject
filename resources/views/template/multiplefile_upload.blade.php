@extends('layouts/default') {{-- Page title --}} @section('title') Multiple File Upload @stop {{-- local styles --}} @section('header_styles')
...
<link rel="stylesheet" type="text/css" href="{{asset('css/custom_css/multiplefile_upload.css')}}"> @stop {{-- Page Header--}} @section('page-header')
