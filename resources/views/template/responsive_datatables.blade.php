@extends('layouts/default') {{-- Page title --}} @section('title') Responsive Datatables @stop {{-- local styles --}} @section('header_styles')
<link rel="stylesheet" type="text/css" href="{{asset('vendors/datatables/css/dataTables.bootstrap.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('vendors/datatablesmark.js/css/datatables.mark.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('css/custom_css/responsive_datatables.css')}}"> @stop {{-- Page Header--}} @section('page-header')
...
<!-- Fifth Table Start -->@stop {{-- local scripts --}} @section('footer_scripts')
<script type="text/javascript" src="{{asset('vendors/datatables/js/jquery.dataTables.js')}}"></script>
<script type="text/javascript" src="{{asset('vendors/datatables/js/dataTables.bootstrap.js')}}"></script>
<script src="{{asset('vendors/markjs/jquery.mark.js')}}" charset="UTF-8"></script>
<script src="{{asset('vendors/datatablesmark.js/js/datatables.mark.min.js')}}" charset="UTF-8"></script>
