...
<ul class="navigation slimmenu" id="navigation">
    ...
    <li {!! (Request::is( 'users') || Request::is( 'roles') || Request::is( 'user_profile') || Request::is( 'deleted_users') ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        ...
        <ul class="sub-menu ">
            ...
            <li {!! (Request::is( 'roles')? 'class="active "': " ") !!}>
                <a href="{{url( 'roles')}} ">
                    <i class="fa fa-fw ti-user "></i><span class="mm-text "> Roles</span>
                </a>
            </li>
        </ul>
    </li>
    <li {!! (Request::is( 'posts') || Request::is( 'brands') || Request::is( 'user_profile') || Request::is( 'deleted_users') ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        <a href="javascript:void(0) ">
            <i class="menu-icon ti-bookmark "></i>
            <span class="mm-text ">Posts</span> <span class="fa arrow "></span>
        </a>
        <ul class="sub-menu ">
            <li {!! (Request::is( 'posts')? 'class="active "': " ") !!}>
                <a href="{{url( 'posts')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Posts List</span>
                </a>
            </li>
        </ul>
    </li>
    <li {!! (Request::is( 'products') || Request::is( 'brands') || Request::is( 'tags') || Request::is( 'promotions') ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        <a href="javascript:void(0) ">
            <i class="menu-icon ti-gift "></i>
            <span class="mm-text ">Products</span> <span class="fa arrow "></span>
        </a>
        <ul class="sub-menu ">
            <li {!! (Request::is( 'products')? 'class="active "': " ") !!}>
                <a href="{{url( 'products')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Products List</span>
                </a>
            </li>
            <li {!! (Request::is( 'brands')? 'class="active "': " ") !!}>
                <a href="{{url( 'brands')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Brands List</span>
                </a>
            </li>
            <li {!! (Request::is( 'tags')? 'class="active "': " ") !!}>
                <a href="{{url( 'tags')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Tags List</span>
                </a>
            </li>
            <li {!! (Request::is( 'promotions')? 'class="active "': " ") !!}>
                <a href="{{url( 'promotions')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Promotions List</span>
                </a>
            </li>
        </ul>
    </li>
    <li {!! (Request::is( 'customers') || Request::is( 'guests') ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        <a href="javascript:void(0) ">
            <i class="fa fa-fw fa-users"></i>
            <span class="mm-text ">Customers</span> <span class="fa arrow "></span>
        </a>
        <ul class="sub-menu ">
            <li {!! (Request::is( 'customers')? 'class="active "': " ") !!}>
                <a href="{{url( 'customers')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Customers List</span>
                </a>
            </li>
        </ul>
        <ul class="sub-menu ">
            <li {!! (Request::is( 'guests')? 'class="active "': " ") !!}>
                <a href="{{url( 'guests')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Guests List</span>
                </a>
            </li>
        </ul>
    </li>
    <li {!! (Request::is( 'orders') || Request::is( 'brands') || Request::is( 'user_profile') || Request::is( 'deleted_users') ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        <a href="javascript:void(0) ">
            <i class="menu-icon ti-money "></i>
            <span class="mm-text ">Orders</span> <span class="fa arrow "></span>
        </a>
        <ul class="sub-menu ">
            <li {!! (Request::is( 'orders')? 'class="active "': " ") !!}>
                <a href="{{url( 'orders')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Orders List</span>
                </a>
            </li>
        </ul>
    </li>
    <li {!! (Request::is( 'reports') ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        <a href="javascript:void(0) ">
            <i class="menu-icon ti-bar-chart "></i>
            <span class="mm-text ">Reports</span> <span class="fa arrow "></span>
        </a>
        <ul class="sub-menu ">
            <li {!! (Request::is( 'reports')? 'class="active "': " ") !!}>
                <a href="{{url( 'reports')}} ">
                    <i class="fa fa-fw ti-menu-alt " aria-hidden="true "></i><span class="mm-text "> Reports</span>
                </a>
            </li>
        </ul>
    </li>
    <li {!! (Request::is( 'others')  ? 'class="active menu-dropdown"': 'class="menu-dropdown "') !!}>
        <a href="javascript:void(0) ">
            <i class="menu-icon ti-bar-chart "></i>
            <span class="mm-text ">以下是模板其他插件</span> <span class="fa arrow "></span>
        </a>
    </li>
