@extends('layouts/default') {{-- Page title --}} @section('title') Glyphicons @stop {{-- local styles --}} @section('header_styles')
<link href="{{asset('vendors/toastr/css/toastr.min.css')}}" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="{{asset('css/custom_css/glyphicons.css')}}"> @stop {{-- Page Header--}} @section('page-header')
...
<script src="{{asset('js/custom_js/glyphicons.js')}}"></script> @stop
