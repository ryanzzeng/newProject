@extends('layouts/default') {{-- Page title --}} @section('title') Buttons @stop {{-- local styles --}} @section('header_styles')
<link href="{{asset('vendors/hover/css/hover-min.css')}}" rel="stylesheet">
<link rel="stylesheet" href="{{asset('vendors/laddabootstrap/css/ladda-themeless.min.css')}}">
<link href="{{asset('css/buttons_sass.css')}}" rel="stylesheet">
<link href="{{asset('css/advbuttons.css')}}" rel="stylesheet"> @stop {{-- Page Header--}} @section('page-header')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="example example-buttons">
                                <button type="button" class="btn btn-icon btn-default m-r-50"><i class="icon fa fa-fw ti-location-pin" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn btn-icon btn-primary m-r-50"><i class="icon fa fa-fw ti-layout-grid3" aria-hidden="true"></i>
                                </button>
...
<script type="text/javascript" src="{{asset('js/custom_js/button_main.js')}}"></script> @stop
