@extends('layouts/default') {{-- Page title --}} @section('title') Notifications @stop {{-- local styles --}} @section('header_styles')
...
<link href="{{asset('vendors/pnotify/css/pnotify.history.cs')}}s" rel="stylesheet" type="text/css" />
                    ...
                    <div id="form_notice" style="display: none;">
                        <form class="pf-form pform_custom" method="post">
                            ...
                            <div class="pf-element pf-buttons pf-centered">
                                <input class="pf-button btn btn-default" type="submit" name="submit" value="Submit" />
            ...
            <div class="row notif-types text-center">
                <div class="col-sm-4 m-t-30">
                    <div class="form-group">
                        ...
                        <br>
                        <select id="animate_in" class="custom-select form-control effect_in_margin_top" style="display: inline; width: auto;">
                ...
                <div class="col-sm-4 m-t-30">
                    <div class="form-group">
                        ...
                        <br>
                        <select id="animate_out" class="custom-select form-control" style="display: inline; width: auto;">
...
<script src="{{asset('js/custom_js/notifications.js')}}"></script> @stop
