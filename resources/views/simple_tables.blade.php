@extends('layouts/default') {{-- Page title --}} @section('title') Simple Tables @stop {{-- local styles --}} @section('header_styles')
<link href="{{asset('css/datatable.css')}}" rel="stylesheet"> @stop {{-- Page Header--}} @section('page-header')
